                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <div className="flex items-center ms-3">
                                <a onClick={props.click_icon} className="flex items-center p-2 text-black rounded-lg hover:bg-color-hover hover:text-white group">
            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-color-component border-r border-color-border sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 pb-4 overflow-y-auto bg-color-component">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <a href="#" onClick={props.click_icon} className={`${true} bg-color-hover flex items-center p-2 text-black rounded-lg hover:bg-color-hover hover:text-white group`}>
                        ...
                        <li>
                            <a href="#" onClick={props.click_icon} className="flex items-center p-2 text-black rounded-lg hover:bg-color-hover hover:text-white group">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-black rounded-lg hover:bg-color-hover hover:text-white group">
